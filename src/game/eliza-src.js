...
export const ELIZA_README = [
  ...
  '',
  'eliza.ml reads what you type with readLine and answers until you type quit.',
  'Ctrl-C or Escape stops it wherever it is.',
  '',
...
// A working ELIZA in the laptop's own ML. It reads, it answers, and it keeps
// going until you tell it to stop — the loop is `readLine`, the language's own
// input primitive, so the conversation happens IN the ML and not in a host
