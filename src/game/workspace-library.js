...
export const APPS = {
  ...
  'WorldWideWeb.app': bundle('WorldWideWeb', '1.0', [
    'HyperMedia Browser/Editor. An exercise in global information',
    'availability. Alpha only.',
    '',
    'There is no address bar. To reach a document you have not been',
    'linked to: Document, then Open from full document reference,',
    'then type the reference, then Open.',
    '',
    'Double-click a link to follow it. A single click puts the caret',
    'in the text, because this is an editor as much as a browser.',
    '',
    'Every document opens in its own window. There is no Back.',
  ]),
  'Grove.app': bundle('Grove', '1.0', [
    'A model of the floor, running.',
    '',
    'It is not connected to the floor. The floor is not running. What',
    'you are watching is what it would do, computed here, on a grid the',
    'shape of the clearing.',
    '',
    'It opens on the word the lumen spells and then obeys Conway, which',
