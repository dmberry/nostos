...
export const AIH_RINGS = [
  ring(R.main[0], 'HISTORY OF AI RING', 'History of AI Ring', 'deeplearning',
    ...
    [['boolean-logic.geocities.ws', 'Boole / the Laws of Thought'],
     ...
     ['serbelloni-1972.geocities.ws', 'Serbelloni, 1972'],
     ['lighthill-and-after.geocities.ws', 'Lighthill and after'],
     ['the-reserved-conclusion.geocities.ws', 'The reserved conclusion'],
