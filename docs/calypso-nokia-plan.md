...
the sci-17 DCT3/MAD2WD1 lore fragment. v1.117–1.121: the handset IS the modal — the
live LCD is overlaid on the sprite's own screen window, so texts and Snake
happen on the phone's actual glass. Settled framing (v1.121, after trying a
