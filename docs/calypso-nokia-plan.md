...
the sci-17 DCT3/MAD2WD1 lore fragment. v1.117–1.120: the handset IS the modal — the
...
frame; the LCD type scales with the glass, the body renders dimmed
(brightness 0.62) so only the lit screen draws the eye, and texts and Snake
happen on the phone's actual screen (LCD-only fallback under 720px). The
