...
Nine complete works ship in `assets/media/laptop/books/`: Homer's *Odyssey* in
Samuel Butler's translation, Butler's *The Authoress of the Odyssey* and
*Erewhon*, Plato's *Republic*, Marcus Aurelius's *Meditations*, Mary Shelley's
...
Music: J. S. Bach, *Ich ruf' zu dir, Herr Jesu Christ*, BWV 639, played from note
data generated from the [Mutopia Project](https://www.mutopiaproject.org) edition
typeset by Gérard Gréco (Mutopia-2007/07/01-756), licensed
[CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/); the licence
applies to `src/engine/chorale-notes.js`. *Daisy Bell* is Harry Dacre's, 1892.
...
are complete; the Basis Library is 29 structures and 430 members; and it scores
...
crossings, the AI-ML filesystem and card state machine, ship/boat rules, the
